// Dynamic Meta Tags Service for CorridorOne
...
const BASE_URL = 'https://corridorone.app';
const DEFAULT_IMAGE = 'https://corridorone.app/favico/og-image.png';
...
export function updateMetaTagsForStory(meta: StoryMeta): void {
  ...
  const title = `${countryName} Intelligence Brief | CorridorOne`;
...
export function resetMetaTags(): void {
  const defaultTitle = 'CorridorOne - Global Situation with AI Insights';
...
function generateDescription(
  ...
  return `CorridorOne ${parts.join('. ')}. Free, open-source geopolitical intelligence.`;
}
