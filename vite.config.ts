...
const VARIANT_META: Record<string, {
  ...
  world: {
    title: 'CorridorOne - Real-Time Global Intelligence Dashboard',
    ...
    url: 'https://corridorone.app/',
    siteName: 'CorridorOne',
    features: [
  ...
  tech: {
    ...
    url: 'https://tech.corridorone.app/',
  ...
  return {
    ...
    transformIndexHtml(html) {
      return html
        ...
        .replace(/"name": "CorridorOne"/, `"name": "${meta.siteName}"`)
        .replace(/"alternateName": "CorridorOne"/, `"alternateName": "${meta.siteName.replace(' ', '')}"`)
        .replace(/"url": "https:\/\/corridorone\.app\/"/, `"url": "${meta.url}"`)
